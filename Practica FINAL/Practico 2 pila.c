...
void AgregarProyecto(Pila **);
void ImprimirProyectos(Pila *);
void EliminarProyecto(Pila **);
void CalcularAvance(Pila *);
void Menu();
...
void Menu(){
    ...
    do{
        ...
        printf("3) Eliminar el ultimo proyecto registrado\n");
...
void AgregarProyecto(Pila **pila){
...
void ImprimirProyectos(Pila *pila){
    Pila *aux = pila;
...
void EliminarProyecto(Pila **pila){
    Proyecto proyecto = (*pila)->proyecto;
    Pila *aux = *pila;
    *pila = aux->sig;
    free(aux);
